...
def main():   
   ...
   parser.add_argument('--output_path', type=str, default="output/apple2", help='Directory path to save captured images.')
   parser.add_argument('--model_path', type=str, default="C:/Users/ihjune/voxel_carving/3D_Model/dataset/apple2.ply", help='Path to the 3D model file.')
   ...
   initial_name = os.path.join(file_name,"initial.png")
   viewer.poll_events()
   ...
   viewer.poll_events()
   viewer.update_renderer()
   rotated_name = os.path.join(file_name,f"rotated{rotation_angle}.png")
