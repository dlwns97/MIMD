...
def main():
    ...
    parser.add_argument('--output_path', type=str, default="C:/Users/user/Desktop/Workspace/231023_objply/3D/output",
                        help='Directory path to save captured images.')
    parser.add_argument('--model_path', type=str, default="C:/Users/user/Desktop/Workspace/231023_objply/garuda-and-vishnu-ply/Garuda and Vishnu.ply",
    ...
    ctr.rotate(rotation_angle/3, 0.0)
    viewer.poll_events()
    viewer.update_renderer()
